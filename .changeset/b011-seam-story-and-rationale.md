...
it: a throw means the 200 is never built, the rejection reaches the route's error boundary, and
TheoKit answers 500 where the platform expected an acknowledgement. `parseInbound` returning `null`
